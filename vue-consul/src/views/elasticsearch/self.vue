  ...
  <div class="app-container">
    <div class="filter-container" style="flex: 1;display: flex;align-items: center;height: 50px;">
      ...
      <el-upload
        ...
        class="upload-demo"
        action="/api/selfelasticsearch/upload"
        :headers="myHeaders"
        :on-success="success"
        :on-error="error"
        accept=".xlsx"
...
import { getAllList, getAllInfo, addService, updateService, delService } from '@/api/selfelasticsearch'
export default {
  name: 'ComplexTable',
  ...
  data() {
    ...
    return {
      ...
      multipleSelection: [],
      del_dict: {},
      osport: { linux: '2181', windows: '2181' },
      temp: {
        vendor: '',
        account: '',
        region: '',
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        excel.export_json_to_excel({
          header: tHeader,
          data,
          filename: 'selfelasticsearch-list'
        })
