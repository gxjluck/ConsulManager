  ...
  <div class="app-container">
    <div class="filter-container" style="flex: 1;display: flex;align-items: center;height: 50px;">
      ...
      <el-upload
        ...
        class="upload-demo"
        action="/api/selfmemcached/upload"
        :headers="myHeaders"
        :on-success="success"
        :on-error="error"
        accept=".xlsx"
...
import { getAllList, getAllInfo, addService, updateService, delService } from '@/api/selfmemcached'
export default {
  name: 'ComplexTable',
  ...
  data() {
    ...
    return {
      ...
      multipleSelection: [],
      del_dict: {},
      osport: { linux: '9092', windows: '9092' },
      temp: {
        vendor: '',
        account: '',
        region: '',
